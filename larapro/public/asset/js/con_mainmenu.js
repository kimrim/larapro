 $(function() {  
    $.fn.conmain_popup=function(options){
        $.defaultOptions = {
            id2       : "",
            id      : "",
            title       : "",
		...
		resizable: false,
           ...
           function nextfocus(id) {
              ...
              }else if(id2 == "31"){/*table입력: 3으로 시작*/
                  $("#" + id).parent().next().next().find("input").focus();
              }else if(id2 == "34"){/*table입력: 3으로 시작*/
                  $("#" + id).parent().next().find("input").focus();
              }else if(id2 == "32"){/*table입력: 3으로 시작*/
                  $("#" + id).parents("tr").next().find("input:eq(0)").focus();
              }else if(id2 == "33"){/*table입력: 3으로 시작*/
                  $("#" + id).parents("tr").next().find("input:eq(1)").focus();
              }else if(id2 == "15"){
                  $("#" + id).parent().parent().next().next().find("input").focus();
              }else if(id2 == "16"){
                  $("#" + id).parent().parent().next().next().find("button").focus();
              }else if(id2 == "19"){
                  $("#" + id).parent().parent().parent().next().find("button").focus();
              }else if(id2 == "20"){
        ...
        $('input.conmain-dialog').each(function(){
            ...
            if(id3 == "1"){
                ...
                title = $this.parent().prev().text();
            } else if(id3 == "5" || id3 == "8" || id3 == "9"){
                title = $this.parent().parent().prev().text();
            } else if(id3 == "6"){
                var tid = "#" + subject + "td";
                title = $(tid).text();
            } else if(id3 == "7"){
            ...
            $this.click(function(){
                $this.conmain_popup({id2:id2, id:id, title:title, url:url, ids:ids, table_pop:table_pop});  
            });
        ...
        $(".conmain_popup tbody").on( 'click', 'tr', function () {
