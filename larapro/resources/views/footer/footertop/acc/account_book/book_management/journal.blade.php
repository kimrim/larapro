<!-- dialog_bu -->
<div id="dialog_bu" class="lookup_popup" title="부서" style="display:none; padding: 7px;"> 
...
<!-- dialog_sa -->
<div id="dialog_sa" class="lookup_popup" title="사원" style="display:none; padding: 7px;"> 
  <p style="font-size: 12px;">아무 것도 하지 않을 것입니다. 동의하십니까?</p>
  <table id="" class="display nowrap" cellspacing="0" width="100%">
    <thead>
      <tr class="success">
