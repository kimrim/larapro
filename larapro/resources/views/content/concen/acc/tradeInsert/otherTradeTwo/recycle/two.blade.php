                    ...
                    <div class="btn-toolbar">         
                      <div class="btn-group btn-group-xs">
                        ...
                        <ul class="dropdown-menu next410 foc" role="menu">
                          ...
                          <li><a href="#">2.계산서</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <label class="control-label col-md-2">사업자여부</label>
                  <div class="col-md-4">
                    <div class="col-md-8">
                    <label class="radio-inline" style="margin-top: -8px;"><input type="radio" name="inlineRadioOptions2" id="inlineRadio21" value="option1" checked style="margin-top: -2px;">여</label>
                    <label class="radio-inline" style="margin-top: -8px;"><input type="radio" name="inlineRadioOptions2" id="inlineRadio22" value="option2" style="margin-top: -2px;">부</label>
                  </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pop client next310 n" id="client02" style="z-index: 0;" readonly="readonly">
                    </div>
                  </div>
