<div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">수출신고번호</label>
                  <div class="col-md-4">
                    <input type="text" class="form-control input-sm a next120 foc">                    
                  </div>
                  <label class="control-label col-md-2">선(기)적일자</label>
                  <div class="col-md-4">
