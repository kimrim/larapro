      ...
      <div class="col-md-3">
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">  
          ...
          <button type="button" class="btn btn-xs btn-info" title="전기말 까지의 까지의 공사수입금 공사수입금 공사수입금 (도급 ), 완성건물매출 완성건물매출 완성건물매출 (분양 ) 금액을 입력 및 조회하는 조회하는 화면이 나타 납니다 . 기성액 기성액 중에서 선수금은 선수금은 현장등록에서 현장등록에서 현장등록에서 자료를 자료를 불러오지만 불러오지만 공사수입금 공사수입금 (도급 ) 또는 완 성건물매출 성건물매출 (분양)은 전년도까지의 전년도까지의 전년도까지의 전표금액이 전표금액이 당년도로 당년도로 당년도로 이월되어 반영됩니다 반영됩니다 반영됩니다 .
다만 , 프로그램을 프로그램을 최소 사용할 사용할 경우는 직접 입력해줘야 입력해줘야 하며 그 다음 기수부터는 기수부터는 기수부터는 이월 시
자동으로 이월되어 이월되어 반영됩니다 반영됩니다 반영됩니다 .">전기기성(F3)</button> 
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">                                            
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" class="acc109" role="tab" data-toggle="tab">공사원가</a></li>  
              <li role="presentation"><a href="#tab2" class="acc110" role="tab" data-toggle="tab">작업진행률</a></li>    
            </ul>
          </div>
          <div class="panel-body">
               ...
               <table id="tab1_table" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr class="success">
                        ...
                        <th class="" rowspan=2>현장명</th>
                        <th class="" rowspan=2>공사기간</th>
                        <th class="" rowspan=2>공사금액</th>
                        <th class="" colspan=3>기성내역</th>
                  ...
                  <table id="tab2_table" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr class="success">
                        ...
                        <th class="" rowspan=2>현장명</th>
                        <th class="" rowspan=2>공사기간</th>
                        <th class="" rowspan=2>원청회사</th>
                        <th class="" rowspan=2>공사계약금액</th>
                        <th class="" colspan=3>작업진행율</th>
                        <th class="" colspan=2>...</th>       
                      </tr> 
                      <tr class="danger">
                        <th class="">총공사누적비</th>
