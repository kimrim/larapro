      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/spot_ledger.html" class="list-group-item active"><span class="glyphicon glyphicon-film"></span>현장별원장<span class="badge">8</span></a>
                </div>
              </div>
	    </div>
          </div>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">
          ...
          <button type="button" class="btn btn-xs btn-warning" title="조회된 계정과목별로 Sheet가 분리되어 엑셀파일로 변환됩니다 .
조회된 계정과목이 2개이상이고, 변환할 계정과목이 체크되어 있어야 합니다 .">변환(F7)</button>          
          <button type="button" class="btn btn-xs btn-success" title="다수거래처를 조회한 경우, 일괄로 출력할 거래처를 설정하여 인쇄합니다"">일괄출력(CF3)</button> 
           <button type="button" class="btn btn-xs btn-primary toolbar_dialog" id="" title="조회된 거래처의 계정과목 중, 좌측에서 체크된 계정과목만 화면에 반영됩니다">선택조회(F11)</button>     
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">                                            
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" class="acc109" role="tab">현장별</a></li>     
            </ul>
          </div>
          <div class="panel-body">
           <div class="tab-content">
            <div class="tab-pane active" id="tab-tax1"> 
               <div class="col-md-3">
...
<!-- toolbar_dialog -->
<!-- dialog_junLookup -->
<div id="dialog_junLookup" class="lookup_popup" style="display:none; padding: 7px;> /*title="부서사원"*/
