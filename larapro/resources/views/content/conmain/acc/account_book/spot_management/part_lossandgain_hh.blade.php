      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/part_lossandgain_hh.html" class="list-group-item active"><span class="glyphicon glyphicon-film"></span>부문별손익현황<span class="badge">8</span></a>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">
          ...
          <button type="button" class="btn btn-xs btn-primary">원장조회(F6)</button> 
          <button type="button" class="btn btn-xs btn-danger" title="각 과목별의 계정코드를 과목명 앞에 표시해 표시해 줍니다 줍니다.">계정코드(F11)</button>         
          <button type="button" class="btn btn-xs btn-info toolbar_dialog" id="lookup_3_610" title="필요한 조회조건이 입력된 상태에서 검색하여 조회됩니다.">조회(F12)</button>
        </div>
        <ol class="breadcrumb mar_b3">
          <li><a href="#">회계장부</a></li>
          <li><a href="#">현장관리</a></li>
          <li class="active">부문별손익현황</li>
        </ol>
