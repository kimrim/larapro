      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/part_cost_details.html" class="list-group-item active"><span class="glyphicon glyphicon-camera"></span>부문별원가명세서<span class="badge">25</span></a>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3"> 
          ...
          <button type="button" class="btn btn-xs btn-danger">원가설정(F4)</button>   
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">                                           
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              ...
              <li role="presentation"><a href="#tab3" class="acc106" role="tab" data-toggle="tab">부서</a></li>     
            </ul>
          </div>
          <div class="panel-body">
