      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/spot_client_ledger.html" class="list-group-item active"><span class="glyphicon glyphicon-file"></span>현장별 거래처원장(내용)<span class="badge">145</span></a>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">
          ...
          <button type="button" class="btn btn-xs btn-info toolbar_dialog" id="junLookup_1_600" title="조회된 거래내용의 전표입력내용을 조회하거나, 수정합니다"">전표조회/수정(F3)</button>         
          <button type="button" class="btn btn-xs btn-default toolbar_dialog" id="sumOption_1_400" title="조회된 거래내용의 일계,월계,누계를 설정합니다">합계옵션(F6)</button>          
          <button type="button" class="btn btn-xs btn-warning" title="다수거래처를 조회한 경우, 일괄로 출력할 거래처를 설정하여 인쇄합니다"">일괄출력(CF3)</button> 
          <button type="button" class="btn btn-xs btn-success toolbar_dialog" id="" title="조회된 거래처의 계정과목 중, 좌측에서 체크된 계정과목만 화면에 반영됩니다">선택조회(F11)</button>     
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">                                            
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              ...
              <li role="presentation"><a href="#tab2" class="acc107" role="tab" data-toggle="tab">내용</a></li> 
              <li role="presentation"><a href="#tab3" class="acc106" role="tab" data-toggle="tab">총괄잔액</a></li>  
              <li role="presentation"><a href="#tab4" class="acc107" role="tab" data-toggle="tab">총괄내용</a></li>      
            </ul>
          </div>
          <div class="panel-body">
           <div class="tab-content">
		    ...
		    <thead>
              ...
              <div class="tab-pane" id="tab4">
                 <div class="col-md-3">
                  <table id="example_93" class="display nowrap" cellspacing="0" width="100%">
		    <thead>
                        <tr class="danger">
                         <th class=""></th>
                        <th class="">코드</th>
...
<!-- dialog_lookup -->
<div id="dialog_lookup" class="lookup_popup" style="display:none; padding: 7px;> /*title="부서사원"*/
  <p style="font-size: 12px;">아무 것도 하지 않을 것입니다. 동의하십니까?</p>
  <table id="" class="display nowrap" cellspacing="0" width="100%">
    <thead>
                        <tr class="danger">
...
<!-- dialog_sumOption -->
<div id="dialog_sumOption" class="lookup_popup" style="display:none; padding: 7px;> /*title="부서사원"*/
...
<!-- dialog_s_lookup -->
<div id="dialog_s_lookup" class="lookup_popup" style="display:none; padding: 7px;> /*title="부서사원"*/
  <p style="font-size: 12px;">아무 것도 하지 않을 것입니다. 동의하십니까?</p>
  <div class="row">
...
<div class="modal fade" id="myModal-2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script class="init">
	  ...
	  $("body").con_tab2({exam: "#example_90", url: "../../data/2500_03.txt", lengthChange:true, searching : false, info:false, paging: true});
          $("body").con_tab2({exam: "#example_91", url: "../../data/2500_05.txt", lengthChange:true, searching : false, info:false, paging: true});
          $("body").con_tab2({exam: "#example_92", url: "../../data/2500_05.txt", lengthChange:true, searching : false, info:false, paging: true});
          $("body").con_tab2({exam: "#example_93", url: "../../data/2500_05.txt", lengthChange:true, searching : false, info:false, paging: true});
        });	     
   </script>
