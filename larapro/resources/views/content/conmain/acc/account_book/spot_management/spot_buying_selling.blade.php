      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/spot_buying_selling.html" class="list-group-item active"><span class="glyphicon glyphicon-file"></span>현장별매입매출장<span class="badge">145</span></a>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">
          ...
          <button type="button" class="btn btn-xs btn-danger toolbar_dialog" id="junLookup_1_600" title="조회된 거래내용의 전표입력내용을 조회하거나, 수정합니다"">전표조회/수정(F3)</button>  
          <button type="button" class="btn btn-xs btn-info" title="매입매출전표입력에서 복수거래로 입력한 자료는건건이조회되어 표시됩니다.">복수거래(F4)</button>       
          ...
          <button type="button" class="btn btn-xs btn-warning toolbar_dialog" id="lookup_3_610" title="필요한 조회조건이 입력된 상태에서 검색하여 조회됩니다.">조회(F12)</button>
        </div>
        <ol class="breadcrumb mar_b3">
          <li><a href="#">회계장부</a></li>
          <li><a href="#">현장관리</a></li>
          <li class="active">현장별매입매출장</li>
        </ol>
        <form class="form-inline well well-sm" style="margin-bottom: 2px;">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
               <span class="input-group-addon">023</span>
               <input type="text" class="form-control pop hh next230s n" readonly="readonly">
            </div>
          </div> <br /> <div class="mar_t5"></div>
          <div class="form-group">
