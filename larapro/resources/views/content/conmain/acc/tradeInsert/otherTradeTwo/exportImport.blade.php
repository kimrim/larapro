<ul class="nav nav-tabs mar_tm18" id="myTab" role="tablist">
          <li role="presentation" class="active"><a href="#tab-tax1" role="tab">수출</a></li>  
          <li role="presentation"><a href="#tab-tax2">수입</a></li>
        </ul>
	...
	@include('content.concen.acc.tradeInsert.otherTradeTwo.exportImport.one')
            </div><!-- end well -->
          </div> <!-- end col-md-8 --> 
          <div class="col-md-4">
            <div class="well well-sm">
	...
	@include('content.conmid.acc.tradeInsert.otherTradeTwo.exportImport.one')
       </div> <!-- end well -->
       </div> <!-- end col-md-12 --> 
      </div> <!-- end row -->
      <div class="row">
        ...
        <div class="tab-pane pad_t5" id="tab-tax2"> 
          <form class="form-horizontal" id="form216"> 
           <div class="row"> 
              <div class="col-md-8">
                <div class="well well-sm">              
	@include('content.concen.acc.tradeInsert.otherTradeTwo.exportImport.two')
            </div><!-- end well -->
          </div> <!-- end col-md-8 --> 
          <div class="col-md-4">
            <div class="well well-sm">
	...
	@include('rightbar.acc.tradeInsert.revenue')
           ...
           <div class="col-md-12">
             <div class="well well-sm mar_tm18">       
	@include('content.conmid.acc.tradeInsert.otherTradeTwo.exportImport.two')
       </div> <!-- end well -->
       </div> <!-- end col-md-12 --> 
      </div> <!-- end row -->
      <div class="row">
