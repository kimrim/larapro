<form class="form-inline well well-sm mar_tm18">
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">       
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist" style="margin-bottom: 2px;">
              ...
              <li role="presentation"><a href="#tab6" class="acc109" role="tab" data-toggle="tab">회수</a></li>
            </ul>
          </div>
	...
	@include('rightbar.acc.tradeInsert.revenue')
              ...
              <div class="tab-pane" id="tab5"> <!-- fade in class-->
                <div class="panel with-nav-tabs panel-default">
                  <div class="panel-heading"> 
                    <ul class="nav nav-tabs" id="ajaxtabsub" role="tablist" style="margin-bottom: 2px;">
                      <li role="presentation" class="active"><a href="#tab51" class="acc111" role="tab" data-toggle="tab">판매</a></li>
                      <li role="presentation"><a href="#tab52" class="acc111" data-toggle="tab">고정자산</a></li>
                    </ul>
                 </div>
                 <div class="panel-body">
                  <div class="tab-content">
	...
	@include('rightbar.acc.tradeInsert.revenue')
                  ...
                  <div class="tab-pane" id="tab52">
                    <div class="row"> 
                 <div class="col-md-9">
                  <table id="tab52_table" class="display nowrap" cellspacing="0" width="100%">
		    <thead>
                        <tr class="danger">
                         <th>일자</th>
                         <th>전표번호2</th>
