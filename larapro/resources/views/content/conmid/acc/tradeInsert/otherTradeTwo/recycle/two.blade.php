<table class="table table-bordered table-hover table-condensed" id="tax1">
                   <thead>
                     <tr class="success">
                       <th class="wid5"></th>
                       <th class="wid5"></th>
                       <th class="wid13">차량번호</th>
                       <th class="wid13">차대번호</th>
                       <th class="wid15">취득금액</th>
                       <th class="wid22">공제액</th>
                       <th class="wid22">합계</th>
            ...
            <tr class="success">
              ...
              <td><input type="text" class="form-control foc a next110"></td>
              <td><input type="text" class="form-control foc a next110"></td>
