...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.trade_insert.cost')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.trade_insert.revenue')
   @include('content.conbreadcrumb.acc.tradeInsert.trade_insert.cost')
   @include('content.conmain.acc.tradeInsert.trade_insert.cost')
...
@endsection
@section('footertop')
	@include('footer.footertop.acc.tradeInsert.revenue')
@endsection
@section('footermain')
