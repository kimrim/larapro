...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.trade_insert.ilbantrade')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.trade_insert.revenue')
   @include('content.conbreadcrumb.acc.tradeInsert.trade_insert.ilbantrade')
   @include('content.conmain.acc.tradeInsert.trade_insert.ilbantrade')
...
@endsection
@section('footertop')
	@include('footer.footertop.acc.tradeInsert.ilbantrade')
@endsection
@section('footermain')
