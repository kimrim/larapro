...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.taxbill.modification')
@endsection
@section('content')
   @include('content.conmain.acc.tradeInsert.taxbill.modification')
@endsection
@section('footertop')
   @include('footer.footertop.acc.tradeInsert.modification')
@endsection
@section('footermain')
