...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.taxbill.handling')
@endsection
@section('content')
   @include('content.conmain.acc.tradeInsert.taxbill.handling')
@endsection
@section('footertop')
...
@endsection
@section('scriptbot')
	@include('footer.scriptbot.acc.tradeInsert.taxbill.handling')
@endsection
