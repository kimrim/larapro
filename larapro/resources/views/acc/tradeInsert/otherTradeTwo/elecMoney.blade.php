...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.otherTradeTwo.elecMoney')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.otherTradeOne.bankTrade')
   @include('content.conbreadcrumb.acc.tradeInsert.otherTradeTwo.elecMoney')
   @include('content.conmain.acc.tradeInsert.otherTradeTwo.elecMoney')
@endsection
@section('footertop')
