 ...
 $.fn.main_popup=function(options){
     ...
     $.fn.calc=function(options){
        ...
        this.each(function(){
          var t0, t1, t2, t3, t4;   
          if(options.dividend == "X_d2"){//cor/A05/international_trade_02/reserve_earnings_calculation_01
             if(options.op == "DdA"){                                                
            ...
            options.par.next().next().next().next().next().find("input:eq(" + ind0 + ")").val(t0);
          ...
          } else if(options.dividend == "X_c1e2"){
          ...
          } else if(options.dividend == "X_b1d1"){
          ...
          } else if(options.dividend == "X_c1e1"){
             ...
             options.par.next().next().next().next().next().find("input:eq(" + ind1 + ")").val(t1);                   
          } else if(options.dividend == "X_ta2"){
             if(options.op == "ASnA"){//A06/common_benefit_01application_earnings_use                                               
          ...
          } else if(options.dividend == "X_y1tta1"){
             if(options.op == "AD"){//A04/AA02/based_sell_plan                                                 
          ...
          } else if(options.dividend == "X_a2b1"){
             if(options.op == "nSmSmnSmarr"){//A02/subject_02/information_contribution                                                  
             ...
             } else if(options.op == "M15"){//A06/sincerity/aa02                                                             
          ...
          } else if(options.dividend == "X_c1ty2"){//cor/A03/deduction/a0913 
             if(options.op == "MnAarrSnMax"){
                 var temp = parseInt(options.par.parent().children(":eq(1)").find("input:eq(0)").val() || 0, 10) - parseInt(options.par.parent().children(":eq(2)").find("input:eq(0)").val() || 0, 10); 
                 t0 = parseInt(options.val || 0, 10)
                 if(temp <= 0){t0 = 0;}
                 t0 *= 20000000; 
          ...
          } else if(options.dividend == "X_d1ty2"){//cor/A03/deduction/a0913 
             if(options.op == "MnAarrSnMax"){
                 var temp = parseInt(options.par.parent().children(":eq(1)").find("input:eq(0)").val() || 0, 10) - parseInt(options.par.parent().children(":eq(2)").find("input:eq(0)").val() || 0, 10) - parseInt(options.par.parent().children(":eq(3)").find("input:eq(0)").val() || 0, 10); 
                 t0 = parseInt(options.val || 0, 10)
                 if(temp <= 0){t0 = 0;}
                 t0 *= 15000000;  
                 var inp = options.par.parent().find("input.Aarr");  
             ...
             options.par.parent().parent().parent().parent().parent().children(":eq(7)").find("input:eq(0)").val(t1);  
             options.par.parent().parent().parent().parent().parent().children(":eq(8)").find("input:eq(0)").val(t2);                        
          } else if(options.dividend == "X_e1ty2"){//cor/A03/deduction/a0913 
             if(options.op == "MnAarrSnMax"){
             ...
             options.par.parent().parent().parent().parent().parent().children(":eq(7)").find("input:eq(0)").val(t1);  
             options.par.parent().parent().parent().parent().parent().children(":eq(8)").find("input:eq(0)").val(t2);                        
          } else if(options.dividend == "X_g1j1l1"){//cor/A03/deduction/a0913 
             if(options.op == "MAarrMin"){
                 var temp = parseInt(options.par.parent().children(":eq(2)").find("input:eq(0)").val() || 0, 10) - parseInt(options.par.parent().children(":eq(3)").find("input:eq(0)").val() || 0, 10); 
                 t0 = parseInt(options.val || 0, 10)
                 if(temp <= 0){t0 = 0;}
                 t0 *= 20000000;                   
          ...
          } else if(options.dividend == "X_h1j1l1"){//cor/A03/deduction/a0913 
             if(options.op == "MAarrMin"){
             ...
             options.par.parent().children(":eq(10)").find("input:eq(0)").val(t1); 
             options.par.parent().children(":eq(12)").find("input:eq(0)").val(t2);                    
          } else if(options.dividend == "X_i1j1l1"){//cor/A03/deduction/a0913 
             if(options.op == "MAarrMin"){
                 var temp = parseInt(options.par.parent().children(":eq(2)").find("input:eq(0)").val() || 0, 10)
                            - parseInt(options.par.parent().children(":eq(3)").find("input:eq(0)").val() || 0, 10) 
                            - parseInt(options.par.parent().children(":eq(7)").find("input:eq(0)").val() || 0, 10) 
             ...
             options.par.parent().children(":eq(10)").find("input:eq(0)").val(t1); 
             options.par.parent().children(":eq(12)").find("input:eq(0)").val(t2);                    
          } else if(options.dividend == "X_1ta2"){
          ...
          } else if(options.dividend == "X_1pdb5"){//cor/A02/subject_01/a05 
             if(options.op == "Maxpr2MMaxTMinSm"){
          ...
          } else if(options.dividend == "X_1d1"){//cor/A05/international_trade_02/reserve_earnings_calculation_02
             ...
             options.par.find("input:eq(" + ind0 + ")").val(t0);
             options.par.next().next().next().next().find("input:eq(" + ind1 + ")").val(t1);                   
          } else if(options.dividend == "X_11"){//cor/A05/international_trade_02/reserve_earnings_calculation_02
             if(options.op == "SarrSmarr"){                                                
                 t0 = parseInt(options.val || 0, 10);
                 var inp = options.par.find("input.Smarr");
                 $(inp).each(function( index ) {
             ...
             options.par.find("input:eq(" + ind0 + ")").val(t0);
             options.par.next().find("input:eq(" + ind1 + ")").val(t1);                   
          } else if(options.dividend == "X_1c2"){//cor/A02/subject_01/a05 
          ...
          } else if(options.dividend == "X_1e2"){//cor/A06/sincerity/aa06 
             if(options.op == "MMinSm"){                                                
          ...
          } else if(options.dividend == "X_1c3e2"){//A02/subject_02/information_contribution  
          ...
          } else if(options.dividend == "X_111"){
            ind0 = options.ind.split("_")[0];
            ind1 = options.ind.split("_")[1];
            ind2 = options.ind.split("_")[2];
            ...
            options.par.next().next().next().find("input:eq(" + ind2 + ")").val(t2);
          } else if(options.dividend == "X_1112m2"){
            var ind0 = options.ind.split("_")[0];
          ...
          } else if(options.dividend == "X_112"){
            var ind0 = options.ind.split("_")[0];
            var ind1 = options.ind.split("_")[1];
            var ind2 = options.ind.split("_")[2];
            var ind3 = options.ind.split("_")[3];
          ...
          } else if(options.dividend == "X_111i2"){
            var ind0 = options.ind.split("_")[0];
            var ind1 = options.ind.split("_")[1];
            var ind2 = options.ind.split("_")[2];
            var ind3 = options.ind.split("_")[3];
            ...
            options.par.next().find("input:eq(" + ind1 + ")").val(t1);                 
            options.par.next().find("input:eq(" + ind2 + ")").val(t2);                                
          } else if(options.dividend == "X_12_a"){
            ind0 = options.ind.split("_")[0];
            ind1 = options.ind.split("_")[1]; 
            ind2 = options.ind.split("_")[2];
            ind3 = options.ind.split("_")[3];
            ...
            options.par.next().find("input:eq(" + ind1 + ")").val(t1);                 
            options.par.next().find("input:eq(" + ind2 + ")").val(t2);                                
          } else if(options.dividend == "X_121"){
            ind0 = options.ind.split("_")[0];
            ind1 = options.ind.split("_")[1];
            ind2 = options.ind.split("_")[2];
            ind3 = options.ind.split("_")[3];
            ...
            options.par.next().next().find("input:eq(" + ind2 + ")").val(t2);
            options.par.next().next().next().find("input:eq(" + ind3 + ")").val(t3);
          } else if(options.dividend == "X_122"){//cor/A02/subject_01/a05 
             if(options.op == "SarrnMaxTn2MinSm"){ 
             ...
             } else if(options.op == "SmarrnMaxTn2MinSm"){ 
                 inp = options.par.find("input.SmarrnMaxTn2MinSm");
                 t0 = 0; 
          ...
          } else if(options.dividend == "X_131"){ 
             ind0 = options.ind.split("_")[0];
             ind1 = options.ind.split("_")[1];
             ind2 = options.ind.split("_")[2];
             ind3 = options.ind.split("_")[3]; 
          ...
          } else if(options.dividend == "X_1pb1c1"){//cor/A03/tax_special_case_01/employ_maintain_earnings_deduction
          ...
          } else if(options.dividend == "X_1pb1c1_a"){//cor/A03/tax_special_case_01/employ_maintain_earnings_deduction
             if(options.op == "DEnSMM"){
                 t0 = parseInt(options.val || 0, 10)/parseInt(options.par.find("input.DdEnSMM").val() || 1, 10);
                 t1 = t0;
          ...
          } else if(options.dividend == "X_1pf1h1"){//cor/A03/tax_special_case_01/a1001 
             if(options.op == "DdMA"){
          ...
          } else if(options.dividend == "X_2prb1o1"){//cor/A03/tax_special_case_011/a1001 
             if(options.op == "SSmMA"){
          ...
          } else if(options.dividend == "X_1pe1r1"){//cor/A03/tax_special_case_011/a1001 
             if(options.op == "DMA"){
                 var inp = options.par.find("input.Ddarr");
                 t0 = 1;
                 $(inp).each(function( index ) {
          ...
          } else if(options.dividend == "X_1pc2i1k1"){//cor/A03/tax_special_case_011/a1001 
             if(options.op == "AarrEDdMA"){
          ...
          } else if(options.dividend == "X_1c2j2h1m2pc1e1"){//cor/A03/tax_special_case_011/a1001 
          ...
          } else if(options.dividend == "X_1ptb2d3"){//A02-subject_01:a06 
             if(options.op == "ASapt2ESpt4ESMinS"){
             ...
             } else if(options.op == "Smapt2ESpt4ESMinS"){
                 var inp = options.par.find("input.ASapt2ESpt4ESMinS");
                 t0 = 0;
                 t0 -= options.val;
                 $(inp).each(function( index ) {
             ...
             options.par.find("input:eq(" + ind0 + ")").val(t0);
             options.par.find("input:eq(" + ind1 + ")").val(t1);                     
          } else if(options.dividend == "X_2d1"){//cor/A05/international_trade_02/reserve_earnings_calculation_02
            ...
            if(options.op == "Dp2M"){//cor/A02/subject_02/a001                                                
                 ...
                 t1 = t0 * parseInt(options.par.prev().prev().find("input:eq(3)").val() || 0, 10);
                 t2 = Math.min(t1, parseInt(options.par.prev().prev().prev().prev().find("input:eq(0)").val() || 0, 10));
            } else if(options.op == "ASmarrSmarr"){//cor/A05/international_trade_02/reserve_earnings_calculation_02                                                
                 t0 = parseInt(options.val || 0, 10) + parseInt(options.my.parent().siblings().find("input.ASmarrSmarr").val() || 0, 10);
                 t1 = parseInt(options.par.find("input.SarrSmarr").val() || 0, 10) - parseInt(options.par.find("input:eq(6)").val() || 0, 10) - t0;
                 t2 = parseInt(options.par.closest("table").parent().parent().prev().find("input:eq(0)").val() || 0, 10) - parseInt(options.par.prev().prev().prev().find("input:eq(7)").val() || 0, 10) - t1;
             } else if(options.op == "A2SmarrSmarr"){                                                
                 t0 = parseInt(options.val || 0, 10) + parseInt(options.my.parent().siblings().find("input.A2SmarrSmarr").val() || 0, 10);
                 t1 = parseInt(options.par.find("input.SarrSmarr").val() || 0, 10) - parseInt(options.par.find("input:eq(3)").val() || 0, 10) - t0;
                 t2 = parseInt(options.par.closest("table").parent().parent().prev().find("input:eq(0)").val() || 0, 10) - parseInt(options.par.prev().prev().prev().find("input:eq(7)").val() || 0, 10) - t1;
            ...
            options.par.find("input:eq(" + ind1 + ")").val(t1);
            options.par.next().find("input:eq(" + ind2 + ")").val(t2);
          } else if(options.dividend == "X_21_a"){
            if(options.op == "SmSmnSmarr"){//cor/A02/subject_02/information_contribution                                                  
                 t0 = parseInt(options.val || 0, 10) - parseInt(options.par.parents("tr").prev().find("input.nSmSmnSmarr").val() || 0, 10);
                 t1 = parseInt(options.val || 0, 10) - t0;
                 t2 = parseInt(options.par.parents("tr").prev().find("input.sum1").val() || 0, 10) - parseInt(options.par.parents("tr").prev().find("input.nSmSmnSmarr").val() || 0, 10) - t1;
            } else {
          ...
          } else if(options.dividend == "X_2ra2"){
            ...
            options.par.parent().parent().parent().parent().next().find("input:eq(" + ind3 + ")").val(t3);                                
          } else if(options.dividend == "X_2pta3"){//A02-subject_01:a06  
             if(options.op == "SarrSmntS2MinS"){
             ...
             } else if(options.op == "SmarrSmntS2MinS"){
                 var inp = options.par.find("input.SmarrSmntS2MinS");
                 t0 = 0;
          ...
          } else if(options.dividend == "X_2ptb5"){//A02-subject_01:a06 
             if(options.op == "S2arrSmpt2Ept3Smpt2EMinSm"){
             ...
             } else if(options.op == "Sm2arrSmpt2Ept3Smpt2EMinSm"){
                 var inp = options.par.find("input.Sm2arrSmpt2Ept3Smpt2EMinSm");
                 t0 = 0;
             ...
             options.par.find("input:eq(" + ind0 + ")").val(t0);             
             options.par.find("input:eq(" + ind2 + ")").val(t2);               
          } else if(options.dividend == "X_3b2"){//A02/subject_02/information_contribution  
          ...
          /*} else if(options.dividend == "X_03"){
             if(options.op == "SmaASm"){//cor/A02/reserve/special_cost                                                 
                 t2 = parseInt(options.val || 0, 10) + parseInt(options.par.find("input.ASm").val() || 0, 10);
                 t1 = parseInt(options.par.find("input.SaS2").val() || 0, 10) - parseInt(options.val);
                 t0 = parseInt(options.par.find("input.SaS2").val() || 0, 10) - t2;
             } else {

             } 
             options.par.find("input.sum2").val(t2);
             options.par.find("input.sum1").val(t1);
             options.par.find("input.sum").val(t0);*/                     
          } else if(options.dividend == "X_12"){//cor/A02/reserve/research 
             if(options.op == "SAS"){                                                 
                 t2 = parseInt(options.val || 0, 10) - parseFloat(options.par.find("input.Sm").val() || 0, 10);
                 t1 = t2 + parseInt(options.par.next().find("input.prAprS").val() || 0, 10);
                 t0 = parseInt(options.val || 0, 10) - t1;
             } else {
            ...
            options.par.next().find("input.sum1").val(t1);                 
            options.par.next().find("input.sum").val(t0);                                
          /*} else if(options.dividend == "X_05"){ 
             if(options.op == "SarrSmntS2MinS"){
                 var inp = options.par.find("input.SmarrSmntS2MinS");
                 t4 = 0;
                 t4 += parseInt(options.val);
                 $(inp).each(function( index ) {
                     t4 -= parseInt($(this).val() || 0, 10);
                 });
                 t3 = parseInt(options.par.find("input.S2ntS2MinS").val() || 0, 10) - t4;
                 t2 = t3 - parseInt(options.par.parent().parent().next().find("input.Sm2").val() || 0, 10);
                 t1 = Math.min(t3, parseInt(options.par.parent().parent().next().find("input.Min").val() || 0, 10));
                 t0 = t1 - parseInt(options.par.parent().parent().next().find("input.Sm").val() || 0, 10);                 
             } else if(options.op == "SmarrSmntS2MinS"){
                 var inp = options.par.find("input.SmarrSmntS2MinS");
                 t4 = 0;
                 t4 += parseInt(options.par.find("input.SarrSmntS2MinS").val() || 0, 10);
                 $(inp).each(function( index ) {
                     t4 -= parseInt($(this).val() || 0, 10);
                 });
                 t3 = parseInt(options.par.find("input.S2ntS2MinS").val() || 0, 10) - t4;
             ...
             options.par.find("input.sum4").val(t4);
             options.par.find("input.sum3").val(t3);
             options.par.parent().parent().next().find("input.sum2").val(t2);
             options.par.parent().parent().next().find("input.sum1").val(t1);
             options.par.parent().parent().next().find("input.sum").val(t0);  */                 
          }
     ...
     $.fn.calcN=function(options){
        ...
        this.each(function(){
          ...
          if (options.dividend == "T_00_227"){ 
             ...
             var ind2 = options.ind.split("_")[2];  
             var inp;
             if(options.op == "Aarr"){//cor/A03/tax_special_case_02/a1301 : cor/A05/international_trade_02/oversea_local_cor_financial_report: cor/A05/international_trade_01/service_trade_normal_price 
             ...
             } else if(options.op == "AarrSarr"){//cor/A03/tax_confirmation/tax_stsndard_change
                inp = options.par.parent().children().find("input.AarrSarr:eq(" + ind0 + ")");
                $(inp).each(function( index ) {
                     t0 += parseInt($(this).val() || 0, 10);
                }); 
     ...
     $.fn.calcN2=function(options){
        ...
        this.each(function(){
          ...
          if(options.dividend == "T_00_008"){//cor/A03/deduction/deduction_addition_01, cor/A02/reserve/research, cor/A03/deduction/a0913
             ...
             t1 = parseInt(options.par.parent().children().find("input.A:eq(" + ind0 + ")").val() || 0, 10); 
             t1 += t0;

             thissum.val(t0);          
             thissum1.val(t1);
           } else if(options.dividend == "T_01_527"){//cor/A03/deduction/deduction_addition_01  
             var ind0 = options.ind.split("_")[0];
             var ind1 = options.ind.split("_")[1];  
             var ind2 = options.ind.split("_")[2];  
             var ind3 = options.ind.split("_")[3];    
             ...
             t1 = parseInt(options.par.parent().children().find("input.A2:eq(" + ind0 + ")").val() || 0, 10);
             t1 += t0; 
     ...
     $.fn.calcE=function(options){
        ...
        this.each(function(){
          ...
          if(options.dividend == "T_10_001"){//43 25 011
             ...
             } else if(options.op == "A"){//cor/A03/deduction/deduction_addition_01, cor/connection/report/connection_invest_hh                   
                arr0 += parseInt(options.my.val() || 0, 10) + parseInt(options.my.parent().siblings().find("input.A").val() || 0, 10);
     ...
     $.fn.calcB=function(options){
        ...
        this.each(function(){
          ...
          if(options.dividend == "T_12_64a"){//T_12_18a
             var ind0 = options.ind.split("_")[0]; 
             var ind1 = options.ind.split("_")[1];
             var ind2 = options.ind.split("_")[2];
             var ind3 = options.ind.split("_")[3]; 
     ...
     $('input.pop').on("click", function(){
        ...
        $('input.cactax').on("keydown", function(evt){
            var $this = $(this); 
            var $next;
            var previnput = $this.parent().parent().find("td:eq(1)").find("input");
            if(previnput.val() == ""){
               $this.val("");
               previnput.focus();
            }            
