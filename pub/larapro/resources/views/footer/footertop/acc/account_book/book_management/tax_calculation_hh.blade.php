...
<!-- dialog_dailyHh -->
<div id="dialog_dailyHh" class="lookup_popup" style="display:none; padding: 7px;"> 
  <p style="font-size: 12px;">아무 것도 하지 않을 것입니다. 동의하십니까?</p>
  <form class="form-inline well well-sm">
          <div class="form-group">
            <label for="from">거래처명: </label>
            <input type="text" class="form-control open-dialog" id="account" readonly="readonly">
          </div>
          <div class="form-group">
            <label for="from">사업자등록번호: </label>
            <input type="text" class="form-control open-dialog" id="saupno" readonly="readonly">
          </div>    
        </form> 
  <table id="" class="display nowrap" cellspacing="0" width="100%">
    <thead>
