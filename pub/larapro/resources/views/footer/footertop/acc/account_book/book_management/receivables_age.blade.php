<!-- dialog_account -->
<div id="dialog_account" class="lookup_popup" title="계정별거래처" style="display:none; padding: 7px;"> 
...
<!-- dialog_client -->
<div id="dialog_client" class="lookup_popup" style="display:none; padding: 7px;"> 
  <p style="font-size: 12px;">아무 것도 하지 않을 것입니다. 동의하십니까?</p>
  <table id="" class="display nowrap" cellspacing="0" width="100%">
    <thead>
      <tr class="success">
