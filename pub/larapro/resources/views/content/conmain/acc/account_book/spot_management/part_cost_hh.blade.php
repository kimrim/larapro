      ...
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/part_cost_hh.html" class="list-group-item active"><span class="glyphicon glyphicon-file"></span>부문별원가현황<span class="badge">145</span></a>
       ...
       <div class="col-md-9">
        <div class="btn-toolbar mar_b3">
          ...
          <button type="button" class="btn btn-xs btn-primary">원가설정(F4)</button> 
          <button type="button" class="btn btn-xs btn-danger" title="화면에 표시된 계정과목의 원장을 조회하고자 할 때 사용합니다.
각 계정에서 마우스 더블클릭을 하거나 엔터 또는 'F6 원장조회'를 누르면 해당 과목의 원장이 조회되며 , 원장조회 화면에서 조회기간  및 계정과목을 수정하여 조회 할 수 있습니다">원장조회(F6)</button> 
          <button type="button" class="btn btn-xs btn-info" title="각 과목별의 계정코드를 과목명 앞에 표시해 표시해 줍니다 줍니다.">계정코드(F11)</button>         
          <button type="button" class="btn btn-xs btn-default toolbar_dialog" id="lookup_3_610" title="필요한 조회조건이 입력된 상태에서 검색하여 조회됩니다.">조회(F12)</button>
        </div>
        <ol class="breadcrumb mar_b3">
          <li><a href="#">회계장부</a></li>
          <li><a href="#">현장관리</a></li>
          <li class="active">부문별원가현황</li>
        </ol>
        <form class="form-inline well well-sm" style="margin-bottom: 2px;">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
               <span class="input-group-addon">023</span>
               <input type="text" class="form-control pop hh next230 n" readonly="readonly">
            </div>
        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">                                            
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" class="acc114" role="tab" data-toggle="tab">도급현장</a></li>  
              <li role="presentation"><a href="#tab2" class="acc114" role="tab" data-toggle="tab">분양현장</a></li>
              <li role="presentation"><a href="#tab3" class="acc114" role="tab" data-toggle="tab">부서</a></li>     
            </ul>
          </div>
          <div class="panel-body">
...
<div class="modal fade" id="myModal-2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script class="init">	
	  ...
	  $("body").con_tab2({exam: "#example_90", url: "../../data/2500_03.txt", lengthChange:true, searching : false, info:false, paging: true});
          $("body").con_tab2({exam: "#example_91", url: "../../data/2500_03.txt", lengthChange:true, searching : false, info:false, paging: true});
          $("body").con_tab2({exam: "#example_92", url: "../../data/2500_03.txt", lengthChange:true, searching : false, info:false, paging: true});
        });
   </script>
