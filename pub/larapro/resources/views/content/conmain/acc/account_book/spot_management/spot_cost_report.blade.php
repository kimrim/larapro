    ...
    <div class="row">
      <div class="col-md-3">
        <div class="well well-sm">        
		  ...
		  <p>무엇을 써야하나?</p>
	        ...
	        <div class="list-group">
                  ...
                  <a href="../spot_management/spot_cost_report.html" class="list-group-item active"><span class="glyphicon glyphicon-music"></span>현장별원가보고서<span class="badge">50</span></a>
       ...
       <div class="col-md-9">
        ...
        <div class="well" style="margin-bottom: 5px; padding-left: 5px; padding-right: 5px;">                                             
               <div class="col-md-3">
...
<!-- dialog_hh -->
<div id="dialog_hh" class="lookup_popup" style="display:none;> /*title="부서사원"*/
...
<div class="modal fade" id="myModal-2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script class="init">	
       $(document).ready(function() {
           $("body").con_tab2({exam: "#example_90", url: "../../data/2500_03.txt", scrollY: 239, lengthChange:true, searching:false, info:false});
           $("body").con_tab3({cla2: "1", exam: "#example", url: "../../data/2500_03.txt", lengthChange:false, info:false});
        });
   </script>
