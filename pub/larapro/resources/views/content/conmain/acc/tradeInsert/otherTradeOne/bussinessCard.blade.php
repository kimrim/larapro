<form class="form-inline well well-sm mar_tm18" style="margin-bottom: 2px;">
        ...
        <div class="panel with-nav-tabs panel-info">
          <div class="panel-heading">
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist">
              ...
              <li role="presentation"><a href="#tab3" class="acc116" role="tab" data-toggle="tab">출금</a></li>
            </ul>
          </div>
	...
	@include('content.concen.acc.tradeInsert.otherTradeOne.bussinessCard.total')
                </div>              
            </div>            
          </div>                
        ...
        <div class="tab-pane" id="tab2"> 
          <div class="row">
            <div class="col-md-12"> 
              <div class="well well-sm">            
	@include('content.concen.acc.tradeInsert.otherTradeOne.bussinessCard.deposit')
                </div>
                <div class="well well-sm mar_tm18">  
	@include('content.conmid.acc.tradeInsert.otherTradeOne.bussinessCard.deposit')
              </div>
            </div>           
          </div>                             
      ...
      <div class="tab-pane" id="tab3">
          <div class="row">
            <div class="col-md-12"> 
             <div class="well well-sm"> 
	@include('content.concen.acc.tradeInsert.otherTradeOne.bussinessCard.withdraw')
                </div>
                <div class="well well-sm mar_tm18">  
	@include('content.conmid.acc.tradeInsert.otherTradeOne.bussinessCard.withdraw')
               </form>             
              </div>
            </div>           
          </div>                             
