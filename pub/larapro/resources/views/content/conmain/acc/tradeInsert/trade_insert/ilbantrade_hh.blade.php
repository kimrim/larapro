        ...
        <div class="panel with-nav-tabs panel-default">
          <div class="panel-heading">      
            <ul class="nav nav-tabs" id="ajaxtab3" role="tablist" style="margin-bottom: 2px;">
              <li role="presentation" class="active"><a href="#tab1" class="acc111" role="tab" data-toggle="tab">일반</a></li>  
              <li role="presentation"><a href="#tab2" class="acc111" role="tab" data-toggle="tab">영수증</a></li>
              <li role="presentation"><a href="#tab3" class="acc115" role="tab" data-toggle="tab">가수/가지급</a></li>
              <li role="presentation"><a href="#tab4" class="acc112" role="tab" data-toggle="tab">접대비</a></li>
              <li role="presentation"><a href="#tab5" class="" role="tab" data-toggle="tab">추기</a></li>
              <li role="presentation"><a href="#tab6" class="" role="tab" data-toggle="tab">추가2</a></li>
            </ul>
          </div>
