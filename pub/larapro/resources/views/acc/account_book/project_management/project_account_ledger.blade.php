...
@endsection
@section('sidebar')
	@include('sidebar.acc.account_book.project_management.project_account_ledger')
@endsection
@section('content')
   @include('content.conmain.acc.account_book.project_management.project_account_ledger')
@endsection
@section('footertop')
...
@endsection
@section('scriptbot')
	@include('footer.scriptbot.acc.account_book.project_management.project_account_ledger')
@endsection
