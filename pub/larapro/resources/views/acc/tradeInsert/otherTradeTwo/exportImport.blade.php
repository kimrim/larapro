...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.otherTradeTwo.exportImport')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.otherTradeOne.bankTrade')
   @include('content.conbreadcrumb.acc.tradeInsert.otherTradeTwo.exportInport')
   @include('content.conmain.acc.tradeInsert.otherTradeTwo.exportInport')
