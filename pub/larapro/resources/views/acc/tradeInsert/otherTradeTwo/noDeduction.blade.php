...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.otherTradeTwo.noDeduction')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.otherTradeOne.bankTrade')
   @include('content.conbreadcrumb.acc.tradeInsert.otherTradeTwo.noDeduction')
   @include('content.conmain.acc.tradeInsert.otherTradeTwo.noDeduction')
@endsection
@section('footertop')
