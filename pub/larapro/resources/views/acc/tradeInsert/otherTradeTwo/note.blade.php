...
@endsection
@section('sidebar')
	@include('sidebar.acc.tradeInsert.otherTradeTwo.note')
@endsection
@section('content')
   @include('content.conbutton.acc.tradeInsert.otherTradeOne.bankTrade')
   @include('content.conbreadcrumb.acc.tradeInsert.otherTradeTwo.note')
   @include('content.conmain.acc.tradeInsert.otherTradeTwo.note')
